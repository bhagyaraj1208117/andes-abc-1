...
import (
	...
	github_com_bhagyaraj1208117_andes_abc_1_data_vm "github.com/bhagyaraj1208117/andes-abc-1/data/vm"
...
type SmartContractResult struct {
	...
	Value          *math_big.Int                                            `protobuf:"bytes,2,opt,name=Value,proto3,casttypewith=math/big.Int;github.com/bhagyaraj1208117/andes-abc-1/data.BigIntCaster" json:"value"`
	...
	RelayedValue   *math_big.Int                                            `protobuf:"bytes,6,opt,name=RelayedValue,proto3,casttypewith=math/big.Int;github.com/bhagyaraj1208117/andes-abc-1/data.BigIntCaster" json:"relayedValue"`
	...
	CallType       github_com_bhagyaraj1208117_andes_abc_1_data_vm.CallType `protobuf:"varint,13,opt,name=CallType,proto3,casttype=github.com/bhagyaraj1208117/andes-abc-1/data/vm.CallType" json:"callType"`
...
func (m *SmartContractResult) GetCallType() github_com_bhagyaraj1208117_andes_abc_1_data_vm.CallType {
	if m != nil {
		return m.CallType
	}
	return 0
...
var fileDescriptor_edc1605de0d3d805 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 13:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CallType |= github_com_bhagyaraj1208117_andes_abc_1_data_vm.CallType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
