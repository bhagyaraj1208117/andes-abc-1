//go:generate protoc -I=. -I=$GOPATH/src/github.com/bhagyaraj1208117/andes-abc-1/data/block -I=$GOPATH/src -I=$GOPATH/src/github.com/bhagyaraj1208117/protobuf/protobuf --gogoslick_out=$GOPATH/src outportBlock.proto

package outport

import (
	"github.com/bhagyaraj1208117/andes-abc-1/data"
	"github.com/bhagyaraj1208117/andes-abc-1/data/block"
)
